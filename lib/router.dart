...
final GoRouter appRouter = GoRouter(
  ...
  redirect: (context, state) async {
    ...
    final isOnAuthPage = location == '/cliente/client_auth' || location == '/entregador/delivery_auth';
  ...
  routes: [
    GoRoute(
      ...
      pageBuilder: (context, state) => buildTransitionPage(const SizedBox.shrink(), // vazio
    state)),
    GoRoute(
      path: '/splash',
      name: 'splash',
      pageBuilder: (context, state) => buildTransitionPage(const SplashScreen(),
    state)),
    GoRoute(
      path: '/onboarding',
      name: 'onboarding',
      pageBuilder: (context, state) => buildTransitionPage(const OnboardingPage(),
    state)),
    GoRoute(
    ...
    GoRoute(
      ...
      name: 'client_auth',
      pageBuilder: (context, state) => buildTransitionPage(const ClientAuthPage(),
    state)),
    GoRoute(
      path: '/cliente/client_home',
      name: 'client_home',
      pageBuilder: (context, state) => buildTransitionPage(const ClientHomePage(),
    state)),
    GoRoute(
      path: '/cliente/client_profile',
      name: 'client_profile',
      pageBuilder: (context, state) => buildTransitionPage(const ClientProfilePage(),
    state)),
    GoRoute(
      path: '/cliente/client_createorder',
      name: 'client_createorder',
      pageBuilder: (context, state) => buildTransitionPage(const ClientCreateOrderPage(),
    state)),
    GoRoute(
      ...
      pageBuilder: (context, state) {
        ...
        return buildTransitionPage(ClientOrderStatePage(orderId: orderId), state);
      },
    ),
    GoRoute(
    ...
    GoRoute(
      ...
      name: 'client_history',
      pageBuilder: (context, state) => buildTransitionPage(const ClientHistoryPage(),
    state)),
    GoRoute(
      path: '/entregador/delivery_auth',
      name: 'delivery_auth',
      pageBuilder: (context, state) => buildTransitionPage(const DeliveryAuthPage(),
    state)),
    GoRoute(
      path: '/entregador/delivery_home',
      name: 'delivery_home',
      pageBuilder: (context, state) => buildTransitionPage(const DeliveryHomePage(),
    state)),
    GoRoute(
      path: '/entregador/delivery_profile',
      name: 'delivery_profile',
      pageBuilder: (context, state) => buildTransitionPage(const DeliveryProfilePage(),
    state)),
    GoRoute(
      path: '/entregador/delivery_history',
      name: 'delivery_history',
      pageBuilder: (context, state) => buildTransitionPage(const DeliveryHistoryPage(),
    state)),
    GoRoute(
      path: '/entregador/delivery_orderslist',
      name: 'delivery_orderslist',
      pageBuilder: (context, state) => buildTransitionPage(const DeliveryOrdersListPage(),
    state)),
    GoRoute(
      ...
      pageBuilder: (context, state) {
        ...
        return buildTransitionPage(DeliveryOrderStatePage(orderId: orderId), state);
      },
    ),
    GoRoute(
      path: '/entregador/delivery_support',
      name: 'delivery_support',
      pageBuilder: (context, state) => buildTransitionPage(const DeliverySupportPage(),
    state)),
    GoRoute(
