...
class ClientOrderSummaryPage extends StatefulWidget {
  final Map<String, dynamic>? extra;

  const ClientOrderSummaryPage({super.key, this.extra});

  @override
  State<ClientOrderSummaryPage> createState() => _ClientOrderSummaryPageState();
}

class _ClientOrderSummaryPageState extends State<ClientOrderSummaryPage> {
  ...
  void initState() {
    super.initState();
    // Extract orderId from the extra object
  ...
  void _setRating(int rating) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Avaliação de $rating estrelas enviada!'),
  ...
  Widget _buildOrderSummary(Order order) {
    ...
    final isCompleted = (order.status == OrderStatus.delivered || order.status == OrderStatus.cancelled);
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          // Card principal com mapa e detalhes
          Container(
                    ...
                    child: FilledButton(
                      onPressed: () {
                        if (_rating > 0) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Avaliação de $_rating estrelas enviada com sucesso!'),
