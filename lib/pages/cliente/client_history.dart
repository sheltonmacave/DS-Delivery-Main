...
class _ClientHistoryPageState extends State<ClientHistoryPage>
      ...
      if (mounted) {
        setState(() {
          ...
          _orders = snapshot.docs
              .map((doc) =>
                  ds_order.Order.fromJson({...doc.data(), 'id': doc.id}))
              .where((order) =>
  ...
  Future<void> _fetchRouteForOrder(int index) async {
    if (index < 0 ||
        ...
        !_mapControllers.containsKey(index)) {
      return;
    }
              ...
              if (_isLoading)
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    // Coordenadas
                    final originLocation = LatLng(order.originLocation.latitude,
                                    ...
                                    children: [
                                      ...
                                      GoogleMap(
                                        ...
                                        onMapCreated: (controller) =>
                                            _onMapCreated(controller, index),
                                        liteModeEnabled:
